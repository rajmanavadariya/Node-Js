...
function Viewdash() {
    ...
    const getdata = async () => {
        await axios.get('http://localhost:5555/admin/viewadmin')
            .then((res) => {
                console.log(res)
                setdata(res.data)
            })
    ...
    const deleteData = async (id) => {
        await axios.delete(`http://localhost:5555/admin/deleteadmin?id=${id}`)
            .then((res) => {
                console.log(res)
                navigate('/Dashboard')
    ...
    const updatedata = async (id) => {
        await axios.put(`http://localhost:5555/admin/updatedata?id=${id}`,{withCredentials:true})
            .then((res) => {
                console.log(res)
            ...
            <table>
                ...
                <thead>
                    <tr>
                        ...
                        <th style={{ padding: '5px', border: '1px solid black' }}>Product</th>
